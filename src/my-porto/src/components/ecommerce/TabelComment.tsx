...
export default function TabelComment() {
  ...
  const handleFilterChange = (portofolio: string) => {
    setFilter((prev) => ({
      ...prev,
      portofolio,
    }));
  ...
  return (
    <div className="relative z-4">
      <div className="overflow-visible rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 sm:px-6">
        {/* Header */}
                ...
                <div className="absolute left-0 right-0 top-12 z-50 w-full min-w-[200px] rounded-2xl border border-gray-200 bg-white p-4 shadow-2xl sm:w-72 sm:left-auto sm:right-0 sm:p-5">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      <label
                        className={`flex cursor-pointer items-center gap-2 rounded-xl border sm:px-3 px-2 py-2 sm:text-sm text-[13px] transition-all ${
                          filter.portofolio === ""
          ...
          <Table className="min-w-full border-collapse text-sm">
            <TableHeader className="bg-gray-200 border-y border-gray-100">
              <TableRow>
                <TableCell
                  isHeader
                  className="py-3 font-medium text-gray-600 text-left min-w-[50px]"
                >
                  No
                </TableCell>
                <TableCell
                ...
                <TableCell
                  isHeader
                  className="py-3 font-medium text-gray-600 text-left min-w-[250px]"
                >
                  Message
                </TableCell>
                <TableCell
              ...
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell className="py-10 text-center text-gray-400">
                    <div className="col-span-6">No comments found.</div>
                  </TableCell>
                </TableRow>
              ) : (
                data.map((item, index) => (
                  ...
                  >
                    ...
                    <TableCell className="py-3 text-gray-600 text-sm">
                      {parse(limitWords(item.message, 15))}
                    </TableCell>
